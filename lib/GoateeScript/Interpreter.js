...
(function() {
  ...
  exports.Interpreter = Interpreter = (function() {
    var _aliasSymbol, _aliases, _arguments, _ast, _compile, _compress, _expand, _generate, _index, _load, _operations, _parse, _reference, _save, _scalar, _toExpression, _wrap;
    ...
    Interpreter.generate = _generate = (function() {
      var alias, aliases, assemble, body, clean, code, index, js, key, pattern, runtime, unwrap, value, vars, _i, _len, _ref2;
      aliases = [];
      ...
      assemble = function(object) {
        ...
        for (key in object) {
          ...
          _results.push(body.push(['/* ', key, ' */ ', value.alias, '=', code].join('')));
        }
        return _results;
      };
      assemble(runtime);
