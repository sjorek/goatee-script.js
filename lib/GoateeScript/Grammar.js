...
(function() {
  var $1, $2, $3, $4, $5, $6, $7, $8, Grammar, Parser, aop, bop, e, exports, o, r, s, unwrap, yy, _ref,
  ...
  s = function(patternString) {
    return r(patternString, e);
  };
  ...
  exports.Grammar = Grammar = {
    ...
    bnf: {
      ...
      Rules: [
        o('Rule', function() {
          return [$1];
        }), o('Rules Seperator Rule', function() {
          return $1.concat($3);
        })
      ],
      Rule: [
        o('REFERENCE : Statement', function() {
