...
(function() {
  ...
  exports.Grammar = Grammar = {
    ...
    bnf: {
      ...
      IncDec: [o("++"), o("--")],
      Assignment: [
        o("IncDec REFERENCE", function() {
          return new yy.Expression($1, [$2, 0]);
        }), o("REFERENCE IncDec", function() {
      ...
      Reference: [
        o('REFERENCE', function() {
          ...
          return new yy.Expression('.', [$1, new yy.Expression('resolve', [$2])]);
        }), o('Scope')
      ],
      Resolve: [
        o('REFERENCE', function() {
          return new yy.Expression('resolve', [$1]);
        }), o('Resolve . REFERENCE', function() {
          return new yy.Expression('.', [$1, new yy.Expression('resolve', [$3])]);
        })
      ],
      Property: [
        o('Expression . Resolve', function() {
