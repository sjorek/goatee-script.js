...
(function() {
  var Grammar, Parser, exports, yy, _ref,
  ...
  exports.Grammar = Grammar = (function() {
    var $1, $2, $3, $4, $5, $6, $7, $8, aop, bop, o, r, unwrap;

    $1 = $2 = $3 = $4 = $5 = $6 = $7 = $8 = null;

    Grammar.unwrap = unwrap = /^function\s*\(\)\s*\{\s*return\s*([\s\S]*);\s*\}/;

    Grammar.r = r = function(patternString, action) {
      var match;
    ...
    Grammar.o = o = function(patternString, action, options) {
      var match;
      if (!action) {
    ...
    Grammar.prototype.comment = 'Goatee Script Parser';

    Grammar.prototype.header = function() {
      return "/* " + this.comment + " */\n(function() {\n";
    };

    Grammar.prototype.footer = function() {
