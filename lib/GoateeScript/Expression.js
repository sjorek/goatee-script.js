...
(function() {
  var Expression, Stack, bindFunction, exports, global, isArray, isExpression, isFunction, isNumber, isString, toString, _ref, _ref1,
    __slice = [].slice;
  ...
  exports.Expression = Expression = (function() {
    var _booleanize, _callback, _context, _errors, _evaluate, _execute, _formatRef, _global, _isProperty, _operations, _operator, _parser, _primitive, _process, _property, _scope, _stack, _stringify, _variables;
    ...
    Expression.operations = _operations = {
      ...
      block: {
        ...
        format: function() {
          ...
          return s.join(';').replace(/null(;null)+/g, 'null');
        },
        evaluate: function() {
    ...
    (function() {
      var key, value, _assign, _assignment, _bools, _evaluateRef, _i, _incdec, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _pairs, _raws, _ref2, _single;
