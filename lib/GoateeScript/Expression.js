...
(function() {
  var Expression, Stack, bindFn, exports, global, isArray, isExpression, isFunction, isNumber, isString, toString, _ref, _ref1,
    __slice = [].slice;
  ...
  exports.Expression = Expression = (function() {
    var _booleanize, _callback, _context, _errors, _evaluate, _execute, _global, _isProperty, _operations, _operator, _parser, _primitive, _process, _scope, _silent, _stack, _stringify, _variables;
    ...
    Expression.silent = function(silent) {
      if (silent == null) {
        silent = true;
      }
      return _silent = silent === true;
    };
    ...
    Expression.errors = function() {
      if (_silent && (_errors != null) && _errors.length !== 0) {
        _errors;
      }
      return false;
    };
    ...
    Expression.operations = _operations = {
      ...
      block: {
        ...
        format: function() {
          ...
          return statements.join(';').replace(/null(;null)+/g, 'null');
        },
        evaluate: function() {
    ...
    (function() {
      var key, value, _assign, _assignment, _bools, _evaluateRef, _formatRef, _i, _incdec, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _pairs, _raws, _ref2, _single;
      ...
      for (_i = 0, _len = _incdec.length; _i < _len; _i++) {
        ...
        _operations[key] = {
          format: (function() {
            ...
            return function(a, b) {
              if (b) {
                return "(" + (_formatRef(a)) + k + ")";
              } else {
                return "(" + k + (_formatRef(a)) + ")";
              }
            };
          })(),
          evaluate: (function() {
    ...
    Expression.prototype.evaluate = function(context, variables, stack, scope) {
