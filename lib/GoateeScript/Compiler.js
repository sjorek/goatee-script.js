...
(function() {
  ...
  exports.Compiler = Compiler = (function() {
    ...
    Compiler.ast = _ast = function(data, callback, compress, _impl) {
      var ast, expression;
      if (compress == null) {
        compress = true;
      }
      ...
      expression = isExpression(data) ? data : _impl(data);
    ...
    Compiler.compile = function(data, callback, compress, _impl) {
      ...
      opcode = isArray(data) ? data : _ast(data, callback, false, _impl);
