...
(function() {
  ...
  exports.Grammar = Grammar = (function() {
    var $1, $2, $3, $4, $5, $6, $7, $8, aop, bop, lex, lexer, set, yy;
    ...
    Grammar.addLoggingToParser = function(parser, log) {
      if (log == null) {
        log = function() {
          var args;
    ...
    Grammar.prototype.create = function(comment, prefix, suffix, parser, scope) {
      if (comment == null) {
      ...
      if (parser == null) {
        parser = Grammar.createParser(this, scope);
      }
      return [comment, prefix, parser.generate(), suffix].join('');
    };

    Grammar.prototype._exportGrammar = function() {
      return {
        lex: this.lex,
    ...
    Grammar.prototype.exportJSONString = function(indent) {
      if (indent == null) {
        indent = null;
      }
      if (indent != null) {
      ...
      return JSON.stringify(this._exportGrammar, null, indent);
    };

    Grammar.prototype.exportJSON = function() {
      return JSON.parse(this.exportJSONString());
    };
