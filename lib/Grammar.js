...
(function() {
    var Grammar, Notator, Parser, Scope, Utility, exports, isFunction, isString, path, ref,
        slice = [].slice,
    ...
    Notator = require('./Notator').Notator;
    ...
    exports.Grammar = Grammar = (function() {
        ...
        Grammar.load = function(filename, scope, notator) {
            var ext, grammar;
            if (filename == null) {
                filename = "./misc/grammar/jison.coffee";
            }
            if (scope == null) {
                scope = {};
            }
        ...
        Grammar.prototype["export"] = function() {
            var out;
            out = {
        ...
        Grammar.prototype.toJSONString = function(replacer, indent) {
            ...
            return JSON.stringify(this["export"](), replacer, indent);
        };
