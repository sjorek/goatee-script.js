...
(function() {
    var _cloneObject, cond, del, exports, gulp, skip, util,
    ...
    exports.build = function(name, deps, load, worker) {
        ...
        deps.queue = [];
        fn = function() {
            var assets, clean, destination, i, index, j, len, len1, ref, ref1, ref2, source, subtaskdeps, subtaskname, taskcleandeps, taskconfig, taskdeps, taskname, taskwatchdeps, watch;
